...
/* the line above disables eslint check for this file (temporarily) todo:delete */
  ...
  const handleSubmit = async (e) => {
    ...
    setExistEmail(localStorage.getItem('activeUserEmail'));
    const data = {
      email: email,
    ...
    let is_success;
    try {
      is_success = await authService.edit_info(data);
    } catch (err) {
      console.log('failed to save your new info : ' + err);
      setErrorMessage('Edit info failed, please try again later');
  ...
  return (
    ...
    <form onSubmit={handleSubmit} className={register_styles.reg}>
      ...
      <button className={register_styles.registerButton} id='submitRegister' type='button' onClick={handleSubmit}>Save info</button>
    </form>
  );
